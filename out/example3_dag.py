...
CheckAndMarkRfiRecentDataReadyFile_task = BashOperator(
    ...
    bash_command='ssh -A {{ params.er_cron_host }} /bin/bash {{ params.check_and_mark_max_done_file_script }} {{ params.etl_daily_aggregate_jobs_done_marker_path }} {{ params.rfi_recent_data_ready_marker_path }}',
...
CheckAndMarkRfiRecentConvDataReadyFile_task = BashOperator(
    ...
    bash_command='ssh -A {{ params.er_cron_host }} /bin/bash {{ params.check_and_mark_max_done_file_script }} {{ params.epiphany_daily_attribution_jobs_done_marker_path }} {{ params.rfi_recent_conv_data_ready_marker_path }}',
    params=default_property_config,
    trigger_rule='all_success',
    dag=dag)
...
LoadAdvertiserFilterReducerConfig_task = BashOperator(
    ...
    bash_command='ssh -A {{ params.er_cron_host }} {{ params.CODE_BASE }}/dp/externalreport/whitelist_info_bin --type advertiser --output {{ params.VAR_BASE }}/config_advertiser_filter.yml',
    params=default_property_config,
    trigger_rule='all_success',
    dag=dag)
...
LoadAdvertiserAdMapping_task = BashOperator(
    ...
    bash_command='ssh -A {{ params.er_cron_host }} /bin/bash {{ params.CODE_BASE }}/scripts/hive/load-advertiser-ad-mapping {{ params.environment }} {{ params.reports_db_ro_url }} {{ params.reports_db_ro_username }} {{ params.reports_db_ro_pwd }} {{ params.reports_db_ro_schema }} {{ params.er_cron_date_unified }}',
    params=default_property_config,
    trigger_rule='all_success',
    dag=dag)
...
LoadPublisherFilterReducerConfig_task = BashOperator(
    ...
    bash_command='ssh -A {{ params.er_cron_host }} {{ params.CODE_BASE }}/dp/externalreport/whitelist_info_bin --type publisher --output {{ params.VAR_BASE }}/config_publisher_filter.yml',
    params=default_property_config,
    trigger_rule='all_success',
    dag=dag)
...
LoadAdvertiserConversionDataToHive_task = BashOperator(
    ...
    bash_command='ssh -A {{ params.er_cron_host }} /bin/bash {{ params.load_adv_conv_data_to_hive_script }} {{ params.environment }} {{ params.vertica_reports_db_ro_url }} {{ params.vertica_reports_db_ro_username }} {{ params.vertica_reports_db_ro_pwd }} {{ params.vertica_reports_db_ro_schema }} {{ params.er_cron_date_unified }} {{ params.advertiser_conversion_data_inclusion_days }} {{ params.rfi_recent_conv_data_ready_marker_path }}',
    params=default_property_config,
    trigger_rule='all_success',
    dag=dag)
...
LoadConversionFilterReducerConfig_task = BashOperator(
    ...
    bash_command='ssh -A {{ params.er_cron_host }} {{ params.CODE_BASE }}/dp/externalreport/whitelist_info_bin --type conversion --output {{ params.VAR_BASE }}/config_conversion_filter.yml',
    params=default_property_config,
    trigger_rule='all_success',
    dag=dag)
...
LoadRfiAggregateImpressions_task = BashOperator(
    ...
    bash_command='ssh -A {{ params.er_cron_host }} /bin/bash {{ params.CODE_BASE }}/scripts/hive/load_rfi_aggregate_impressions {{ params.environment }} {{ params.er_cron_date_unified }} {{ params.rfi_agg_data_lookback_days }}',
    params=default_property_config,
    trigger_rule='all_success',
    dag=dag)
...
LoadRfiAggregateConversionAction_task = BashOperator(
    ...
    bash_command='ssh -A {{ params.er_cron_host }} /bin/bash {{ params.CODE_BASE }}/scripts/hive/load_rfi_aggregate_conversion_action {{ params.environment }} {{ params.er_cron_date_unified }} {{ params.rfi_agg_data_lookback_days }}',
    params=default_property_config,
    trigger_rule='all_success',
    dag=dag)
...
LoadRfiXdAggregateConversionAction_task = BashOperator(
    ...
    bash_command='ssh -A {{ params.er_cron_host }} /bin/bash {{ params.CODE_BASE }}/scripts/hive/load_rfi_xd_aggregate_conversion_action {{ params.environment }} {{ params.er_cron_date_unified }} {{ params.rfi_agg_data_lookback_days }}',
    params=default_property_config,
    trigger_rule='all_success',
    dag=dag)
...
AdvertiserReport_task = BashOperator(
    ...
    bash_command='ssh -A {{ params.er_cron_host }} /bin/bash {{ params.CODE_BASE }}/scripts/spark/advertiser_report {{ params.environment }} {{ params.er_cron_date_unified }} {{ params.rfi_agg_data_lookback_days }}',
    params=default_property_config,
    trigger_rule='all_success',
    dag=dag)
...
LoadAdvertiserRatioToVertica_task = BashOperator(
    ...
    bash_command='ssh -A {{ params.er_cron_host }} {{ params.CODE_BASE }}/dp/externalreport/hive_to_vertica_loader_bin --environment {{ params.environment }} --run_date {{ params.er_cron_date_unified }} --look_back_days {{ params.advertiser_param_data_inclusion_days }} --table advertiser_external_ratio',
    params=default_property_config,
    trigger_rule='all_success',
    dag=dag)
...
PublisherReport_task = BashOperator(
    ...
    bash_command='ssh -A {{ params.er_cron_host }} /bin/bash {{ params.CODE_BASE }}/scripts/spark/publisher_report {{ params.environment }} {{ params.er_cron_date_unified }} {{ params.rfi_agg_data_lookback_days }}',
    params=default_property_config,
    trigger_rule='all_success',
    dag=dag)
...
LoadPublisherRatioToVertica_task = BashOperator(
    ...
    bash_command='ssh -A {{ params.er_cron_host }} {{ params.CODE_BASE }}/dp/externalreport/hive_to_vertica_loader_bin --environment {{ params.environment }} --run_date {{ params.er_cron_date_unified }} --look_back_days {{ params.publisher_param_data_inclusion_days }} --table publisher_external_ratio',
    params=default_property_config,
    trigger_rule='all_success',
    dag=dag)
...
LoadAggregateAdLogsAndPublisherDataToVertica_task = BashOperator(
    ...
    bash_command='ssh -A {{ params.er_cron_host }} {{ params.CODE_BASE }}/dp/externalreport/hive_to_vertica_loader_bin --environment {{ params.environment }} --run_date {{ params.er_cron_date_unified }} --look_back_days {{ params.publisher_param_data_inclusion_days }} --table ad_logs_and_publisher_data',
    params=default_property_config,
    trigger_rule='all_success',
    dag=dag)
...
ConversionReport_task = BashOperator(
    ...
    bash_command='ssh -A {{ params.er_cron_host }} /bin/bash {{ params.CODE_BASE }}/scripts/spark/conversion_report {{ params.environment }} {{ params.er_cron_date_unified }}',
    params=default_property_config,
    trigger_rule='all_success',
    dag=dag)
...
LoadConversionRatioToVertica_task = BashOperator(
    ...
    bash_command='ssh -A {{ params.er_cron_host }} {{ params.CODE_BASE }}/dp/externalreport/hive_to_vertica_loader_bin --environment {{ params.environment }} --run_date {{ params.er_cron_date_unified }} --look_back_days {{ params.advertiser_conversion_data_inclusion_days }} --table advertiser_external_conversion_ratio',
    params=default_property_config,
    trigger_rule='all_success',
    dag=dag)
...
XdConversionReport_task = BashOperator(
    ...
    bash_command='ssh -A {{ params.er_cron_host }} /bin/bash {{ params.CODE_BASE }}/scripts/spark/xd_conversion_report {{ params.environment }} {{ params.er_cron_date_unified }}',
    params=default_property_config,
    trigger_rule='all_success',
    dag=dag)
...
CheckAndMarkImpressionReadyDoneFile_task = BashOperator(
    ...
    bash_command='ssh -A {{ params.er_cron_host }} /bin/bash {{ params.check_and_mark_max_done_file_script }} {{ params.rfi_recent_data_ready_marker_path }} {{ params.impression_ready_done_marker_path }}',
    params=default_property_config,
    trigger_rule='all_success',
    dag=dag)
...
CheckAndMarkConversionReadyDoneFile_task = BashOperator(
    ...
    bash_command='ssh -A {{ params.er_cron_host }} /bin/bash {{ params.check_and_mark_max_done_file_script }} {{ params.rfi_recent_conv_data_ready_marker_path }} {{ params.conversion_ready_done_marker_path }}',
    params=default_property_config,
    trigger_rule='all_success',
    dag=dag)
