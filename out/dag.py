...
# Task params
params = {
    'common_args': '--prod_mode false --print_mode true --bootstrap_conf lsv '
                   '--check_marker true --create_marker '
                   'false --package_base /srv/app/autodep'
                   'loy/data.vostok/modeling.pipelines.ag'
                   '_offline.ag_offline_pkg-latest '
                   '--data_date 20170725 --run_id 1 '
                   '--model_configs '
                   'demo_eval_world_atomic --model_dates '
                   '20170307 --model_ids 3295 '
                   '--demo_configs atomic_segments.txt '
                   '--backfill_days 1 --online_hbase_dcs '
                   'lax-arp,eqv-arp,ewr-arp,sjc-arp',
    'ag_offline_script': '/srv/app/autodeploy/data.vostok/modeling.pipelines.'
                         'ag_offline'
                         '.ag_offline_pkg-latest/mo'
                         'deling/pipelines/ag_offli'
                         'ne/driver_bin',
